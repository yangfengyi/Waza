...
**8. bullet 跑成"纯记录" → 第一人称叙事**（扩列表去 list 化策略）
> NO: bullet 全是 passive 陈述（「X 是 Y / X 烧过 / X 不够硬 / X 必须自己写」），读起来像故障报告
> OK: 转 prose 段，加「踩坑 / 老老实实 / 晃 / 一行一行 / 不太对劲 / 最难的是 / 我」等动作-情绪词
...
**10. "我自己 X" personal anchor 频次**
> 工程师谦虚口吻 anchor，但每章节 1 个就够
> NO: 一篇 7 章长文里 4+ 处「我自己的体会」「我自己的感觉」「我自己拿 X 当」「我自己看 X」
> OK: 每章节最多 1 处；密度高时把「我自己的」换成「对我来说」或干脆删主语
